...
@section('page_title', __('admin.cars'))
@section('content')
    <!--begin::Toolbar-->
    <div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
            ...
            @component('dashboard.components.breadcrumb')
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">{{__('admin.cars')}}</li><!--end::Item-->
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                            <div class="fs-5 text-dark fw-bold">{{ __('admin.please-choose') }} {{ __('admin.status') }} {{ __('admin.cars') }}
                            </div>
                        </div><!--end::Header-->
                        ...
                        <div class="px-7 py-5" data-kt-docs-table-filter="form">
                            <!--begin::Input group-->
                            <div class="mb-10">
                                <label class="form-label fs-6 fw-semibold">{{ __('admin.status') }} {{ __('admin.cars') }}:</label>
                                <select class="form-select form-select-solid fw-bold" name="status" data-kt-select2="true" data-placeholder="{{ __('admin.please-choose') }} {{ __('admin.status') }} {{ __('admin.cars') }}" data-allow-clear="true" data-kt-docs-table-filter="search" data-hide-search="true">
                                    <option></option>
                    ...
                    <!--begin::Add customer-->
                    <a href="{{route('cars.create')}}" type="button" class="btn btn-primary" data-bs-toggle="tooltip">
                        {{__('admin.add')}} {{ __('admin.cars') }}
                    </a><!--end::Add customer-->
                </div><!--end::Toolbar-->
...
@push('scripts')
    {{--    ?v={{ now() }}--}}
    <script>
        var route = "{{ route('cars.index', Request()->all()) }}";
        var csrfToken = "{{ csrf_token() }}";
    </script>
    <script src="{{ asset('dashboard-assets/datatables/cars.js') }}"></script>
@endpush
