                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <!--begin::Value-->
                                        <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ __('admin.Users') }}</span>
                                        <!--end::Value-->
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                        <span class="symbol-label bg-gray  text-inverse fw-bold">{{ $users }}</span>
                                    </div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Statistics-->
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <!--begin::Value-->
                                        <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ __('admin.Admins') }}</span>
                                        <!--end::Value-->
                                    ...
                                    <!--begin::Description-->
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                        <span class="symbol-label bg-gray  text-inverse fw-bold">{{ $admins }}</span>
                                    </div>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Value-->
                                        <span
                                            class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ __('admin.services') }}</span>
                                        <!--end::Value-->
                            ...
                            <div class="card-body d-flex flex-column justify-content-end pe-0">
                                ...
                                {{-- <div class="symbol-group symbol-hover flex-nowrap">
                                    @foreach ($categories->slice(0, 3) as $category)
                                        ...
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                            title="{{$category->name}}">
                                            <span class="symbol-label text-inverse-warning fw-bold"
                                                style="background:#8a8989">
                                                {{ $firstLetter }}
                                            </span>
                                        </div>
                                    @endforeach
                                    ...
                                    <a href="#" class="symbol symbol-35px symbol-circle" data-bs-toggle="modal"
                                        ...
                                        <span
                                            class="symbol-label bg-light text-gray-400 fs-8 fw-bold">{{ $categories->count() }}</span>
                                    </a>
                                </div> --}}
                                <!--end::Users group-->
                            </div>
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Amount-->
                                        <span
                                            class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ __('admin.regions') }}</span>
                                        <!--end::Amount-->
                            ...
                            <div class="card-body d-flex align-items-end pt-0">
                                ...
                                <div class="d-flex align-items-center flex-column mt-3 w-100">
                                    <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                        <span class="fw-bolder fs-6 text-dark">{{ __('admin.regions') }}</span>
                                        <span class="fw-bold fs-6 text-gray-400">0%</span>
                                    </div>
                                    <div class="h-8px mx-3 w-100 bg-light-success rounded">
                                        <div class="bg-success rounded h-8px" role="progressbar" style="width: 10%;"
                        ...
                        <div class="card card-flush h-md-50 mb-xl-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    <!--begin::Amount-->
                                    <span
                                        class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ __('admin.Roles & Permissions') }}</span>
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                        <span
                                            class="symbol-label bg-light  text-inverse fw-bold">{{ $roles }}</span>
                                    </div>
