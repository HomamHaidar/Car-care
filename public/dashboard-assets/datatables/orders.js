...
var KTDocsList = function () {
    ...
    var initDocsTable = function () {
        ...
        // Init datatable --- more info on datatables: https://datatables.net/manual/; Hello
                ...
                {data:'car.oil'},
                {
                    ...
                    render: function (data) {
                        if (Array.isArray(data) && data.length > 0) {
                            let servicesList = data.map(service => `<span class="badge badge-light-info me-2">${service.name}</span>`).join('');
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        // Use meta.row to get the row index, and add 1 to start counting from 1
                        return meta.row + 1;
                    },
                },
                {
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="${route}/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between" data-kt-docs-table-filter="edit_row">
